...
def TransitionMatrix(y : list, howtocg : str = 'quantile', numGroups : int = 2, tau : Union[int, str] = 1) -> dict:
    """
...
def MotifTwo(y : list, binarizeHow : Union[str, None] = 'diff') -> dict:
    """
...
def MotifThree(y : list, cgHow : Union[str, None] = 'quantile') -> dict:
    """
...
def BinaryStretch(x : list, stretchWhat : Union[str, None] = 'lseq1'):
    """
...
def BinaryStats(y : list, binaryMethod : Union[str, None] = 'diff'):
    """
    ...
    yBin = _binarize(y, binarizeHow=binaryMethod)
    N = len(yBin)
...
def _binarize(y, binarizeHow='diff'):
    # helper function for BinaryStats
    """
